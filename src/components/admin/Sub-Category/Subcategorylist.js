...
const Subcategorylist = () => {
  ...
  return (
    <div>
      ...
      <br />
      <Link to='/subcategoryadd' className='btn btn-primary'>
          ...
          {loading ? (
            ...
            subcategory.map(temp => (
              <tr key={temp.subcategory_id}>
                ...
                <td>
                  <Link
                    to={`/subcategoryview/${temp.subcategory_id}`}
                  ...
                  &nbsp;
                  <Link
                    to={`/subcategoryedit/${temp.subcategory_id}`}
