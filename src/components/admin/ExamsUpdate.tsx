...
const ExamsUpdate: FC = () => {
  ...
  const examDataIntialState = { exam_id: examId, examname: "", duration: "", numOfQue: "", marksCorrect: "", marksIncorrect: "", launchdate: "", launchtime: "", endDate: "", endTime: "" }
  ...
  return (
    <>
      <h4 className='bg-info bg-opacity-25 text-center py-2 mb-3'>Update Exam Details</h4>
