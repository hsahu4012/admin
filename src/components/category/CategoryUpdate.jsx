...
const CategoryUpdate = () => {
  ...
  useEffect(() => {
    axios
      .get(`${process.env.REACT_APP_API_URL}category/getById/${id}`)
      .then(res => {
        console.log(res);
        let obj = {
    ...
    axios
      .get(`${process.env.REACT_APP_API_URL}categoryimage/${id}`)
      .then(res => {
      ...
      >
        <Form>
          ...
          <div>
            ...
            <Link to='/categoryDetails' className='btn btn-danger'>
              Back
            </Link>
          </div>
        </Form>
