            ...
            >
                <Form className='examAddForm'>
                    ...
                    <div className="row mb-2">
                        ...
                        <Field name="complain_desc" type="text" className='col-6' required />
                    </div>
                    <div className="row mb-2">
                        <label className='col-4 my-2 text-center'>Resolvestatus:-</label>
                        <Field name="resolvestatus" type="text" className='col-6' required />
                    </div>

                    <div className='text-center my-4'>
                        <button type='submit' className='py-1 '>Submit</button>
                        <Link to='/complainslist' className='btn btn-danger back'>Back</Link>
                    </div>
                </Form>
